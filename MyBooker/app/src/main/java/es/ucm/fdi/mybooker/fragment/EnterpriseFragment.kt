...
class EnterpriseFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
       ...
       var gson = Gson()
        ...
        Toast.makeText(this@EnterpriseFragment.context, "1", Toast.LENGTH_SHORT).show()
        Toast.makeText(this@EnterpriseFragment.context, enterprise.enterpriseAddress, Toast.LENGTH_SHORT).show()
